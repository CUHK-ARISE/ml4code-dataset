...
| VulDeePecker | Semantics-based Vulnerability Candidate (SeVC) dataset. Dataset released by NDSS'18 _VulDeePecker: A Deep Learning-Based System for Vulnerability Detection_ ([code](https://github.com/SySeVR/SySeVR)) | Vulnerability Detection | C/C++ | [link](https://github.com/CGCL-codes/VulDeePecker)  |
